...
#-----        Fuente de datos Poblacion España -------------
#-----------------------------------------------------------
...
def estadististicos (fila):
    ...
    return median(lista_invertida), mean(lista_invertida), stdev(lista_invertida), rango, max(lista_invertida),min(lista_invertida), q1,q3,rango_intercuartil
...
def load(lista_final):
    ...
    nombres_columnas = ['Provincia', 'Mediana', 'Media','Desviacion','Rango','Maximo','Minimo','Pimer Quartil (0.25%)', 'Tercer Cuartil (0.75%)', 'Rango Intercuartil']
...
def prog_principal():
    ...
    for fila in data:
        ...
        mediana, media, desviacion, rango,max,min,q1,q3, rango_intercuartil =  estadististicos(fila)
        lista_aux.append(mediana),lista_aux.append(media),lista_aux.append(desviacion),lista_aux.append(rango),lista_aux.append(max),lista_aux.append(min),
        lista_aux.append(q1),lista_aux.append(q3),lista_aux.append(rango_intercuartil)
