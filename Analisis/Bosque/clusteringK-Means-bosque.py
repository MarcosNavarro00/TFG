...
def preparacion():
    ...
    selected_data = data[['Especie', 'Agua Interceptada (M3/Año)', 'Producción Oxígeno (Tn/Año)']]
    ...
    x = selected_data[['Agua Interceptada (M3/Año)', 'Producción Oxígeno (Tn/Año)', 'Especie ID']]
...
def visualizacion(selected_data,kmeans):
    ...
    for cluster in range(n_clusters):
        ...
        ax.scatter(cluster_data['Especie ID'], cluster_data['Agua Interceptada (M3/Año)'], cluster_data['Producción Oxígeno (Tn/Año)'],
                label=f'Cluster {cluster}')

    ax.set_xlabel('Especie')
    ax.set_ylabel('Producción Oxígeno (Tn/Año)')
